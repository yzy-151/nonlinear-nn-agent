    ...
    def _build_prompt(
        ...
        if self.domain is not None:
            ...
            domain_instructions = (
                ...
                "is unknown. Design experiments for the nonlinear-system "
                "modeling goal using only the constraints and history above. "
                "Keep parameter_count_max from constraints; prefer fewer "
                "parameters when the metric is similar. Compare model "
                "performance from history before designing new experiments. "
                "Return overrides as YAML config fields. "
